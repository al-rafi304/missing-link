...
const AssignInvestigator = () => {
    ...
    return (
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
        <div className="p-4 mb-4 rounded bg-red-100 text-red-700">
          Only admins can assign investigators. Please login as an admin.
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
      <h2 className="text-2xl font-bold mb-6 text-center">Assign Investigator</h2>
        ...
        <div className="mb-6">
          <div className="p-4 border rounded mb-4">
            ...
            <p>
              ...
              {caseDetails.investigatorAddress === "0x0000000000000000000000000000000000000000"
                ? "None assigned"
            ...
            caseDetails.investigatorAddress === "0x0000000000000000000000000000000000000000" && (
              <form onSubmit={handleAssign}>
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Assigning..." : "Assign Investigator"}
                </button>
              </form>
            )}
